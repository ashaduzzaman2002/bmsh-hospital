...
const Footer = () => {
  return (
    ...
    >
        ...
        {/* floating card sm */}
        <div className='d-lg-none position-absolute shadow-lg bg-white footer-floating-card p-3 mx-auto' style={{transform:'translateX(5.5%)', borderRadius: '1rem'}}>
            <div>
                <p className='fw-bold'><span style={{color: '#ED3237'}}>Subscribe</span> for the exclusive updates!</p>
            </div>
            <div className='my-2 '>
                <input 
                    className='text-black  d-inline w-100 rounded-pill py-1 px-2' 
                    style={{color: '#D2D2D2', outline: 'none', border: '2px solid #e5e5e5'}} 
                    type="email" 
                    placeholder='Enter Your Email Address'/>
            </div>
            <div className='text-center text-white rounded-pill py-1' style={{background: '#ED3237'}}>
                Subscribe Now
            </div>
        </div>
        ...
        >
            <div>
                <p className='fw-bold m-0 p-0'><span style={{color: '#ED3237'}}>Subscribe</span> for the exclusive updates!</p>
            </div>
        ...
        <div className='footer-container-card-wrapper text-white d-grid ' >
            ...
            <div className='left '>
                <div className='d-flex align-items-center m-0 p-0'>
                    <img className='footer-bmsh-logo m-0 p-0' src={BMSH_LOGO} alt="" />
                    <p className='text-danger ms-2' style={{width: '10rem'}}>Bombay Maternity & Surgical Hospital</p>
                </div>
                <div>
            ...
            <div className='right '>
                ...
                <div className='d-flex flex-column gap-3 mt-4'>
                    <div className='d-flex flex-row'>
                        ...
                        <p className='m-0 p-0 ms-2'>4th floor, Atlanta Shopping Mall, Althan Chokdi Vesu, Althan-Bhimrad canal Road, Surat-395017</p>
                    </div>
                    <div>
        ...
        <div>
            <p className='text-white text-center pb-4 m-0'>All Rights Reserved | Designed & eveloped by Tapti Technology</p>
        </div>
    </div>
  )
}
